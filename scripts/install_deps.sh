...
Darwin)
    case $(sw_vers -productVersion | awk -F . '{print $1"."$2}') in
        ...
        10.12)
            ...
            echo "known issues (see https://github.com/vaporyco/webthree-umbrella/issues/614)."
...
#------------------------------------------------------------------------------
        openSUSE*)
            ...
            echo "See http://cpp-vapory.org/building-from-source/linux.html for manual instructions."
...
*)
    ...
    echo "See http://cpp-vapory.org/building-from-source/ for manual instructions."
