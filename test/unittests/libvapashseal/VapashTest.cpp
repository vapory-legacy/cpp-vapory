...
BOOST_FIXTURE_TEST_SUITE(VapashTests, TestOutputHelperFixture)
...
BOOST_AUTO_TEST_CASE(calculateDifficultyByzantiumWithoutUncles)
{
	...
	BOOST_CHECK_EQUAL(vapash.calculateDifficulty(header, parentHeader), 999024);
}
...
BOOST_AUTO_TEST_CASE(calculateDifficultyByzantiumWithUncles)
{
	...
	BOOST_CHECK_EQUAL(vapash.calculateDifficulty(header, parentHeader), 999512);
}
...
BOOST_AUTO_TEST_CASE(calculateDifficultyByzantiumMaxAdjustment)
{
	...
	BOOST_CHECK_EQUAL(vapash.calculateDifficulty(header, parentHeader), 951688);
}
