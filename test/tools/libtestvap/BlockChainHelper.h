...
{
public:
	explicit NetworkSelector(vap::Network _network) { TestBlockChain::s_sealEngineNetwork = _network; }
	~NetworkSelector() { TestBlockChain::s_sealEngineNetwork = vap::Network::FrontierTest; } // reset to default
};
