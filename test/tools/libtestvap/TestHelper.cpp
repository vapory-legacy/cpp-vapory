...
//	cdebug << "Block mined" << Vapash::boundary(_bi).hex() << Vapash::nonce(_bi) << _bi.hash(WithoutSeal).hex();
...
string netIdToString(vap::Network _netId)
{
	switch(_netId)
	{
		case vap::Network::FrontierTest: return "Frontier";
		case vap::Network::HomesteadTest: return "Homestead";
		case vap::Network::EIP150Test: return "EIP150";
		case vap::Network::EIP158Test: return "EIP158";
		case vap::Network::ByzantiumTest: return "Byzantium";
		case vap::Network::ConstantinopleTest: return "Constantinople";
		case vap::Network::FrontierToHomesteadAt5: return "FrontierToHomesteadAt5";
		case vap::Network::HomesteadToDaoAt5: return "HomesteadToDaoAt5";
		case vap::Network::HomesteadToEIP150At5: return "HomesteadToEIP150At5";
		case vap::Network::EIP158ToByzantiumAt5: return "EIP158ToByzantiumAt5";
		case vap::Network::TransitionnetTest: return "TransitionNet";
...
vap::Network stringToNetId(string const& _netname)
{
	...
	static std::vector<vap::Network> const networks {{
		vap::Network::FrontierTest,
		vap::Network::HomesteadTest,
		vap::Network::EIP150Test,
		vap::Network::EIP158Test,
		vap::Network::ByzantiumTest,
		vap::Network::ConstantinopleTest,
		vap::Network::FrontierToHomesteadAt5,
		vap::Network::HomesteadToDaoAt5,
		vap::Network::HomesteadToEIP150At5,
		vap::Network::EIP158ToByzantiumAt5,
...
string prepareVersionString()
{
	...
	version += "." + string(DEV_QUOTED(VAP_BUILD_OS)) + "." + string(DEV_QUOTED(VAP_BUILD_COMPILER));
	return version;
}
	...
	bytes const& _extraData)
{
	...
	rlpStream << _parentHash << _sha3Uncles << _author << _stateRoot << _transactionsRoot << _receiptsRoot << _logBloom
		<< _difficulty << _number << _gasLimit << _gasUsed << _timestamp << _extraData << h256{} << vap::Nonce{};
