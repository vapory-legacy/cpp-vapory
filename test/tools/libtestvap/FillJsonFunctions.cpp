...
json_spirit::mObject fillJsonWithStateChange(State const& _stateOrig, vap::State const& _statePost, vap::ChangeLog const& _changeLog)
{
	...
	std::sort(changeLog.begin(), changeLog.end(),
		[](const vap::Change& lhs, const vap::Change& rhs )
		{
