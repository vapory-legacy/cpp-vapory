...
# such a standard, we have chosen to make a "fake packaging system" for cpp-vapory, which is
# implemented in https://github.com/vaporyco/cpp-dependencies.
#
...
# https://github.com/vaporyco/webthree-umbrella/issues/509
#
...
# approach which Pawel has taken for LLVM in https://github.com/vaporyco/vvmjit.

if (MSVC)
	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.0.0)
		message(FATAL_ERROR "ERROR - As of the 1.3.0 release, cpp-vapory only supports Visual Studio 2015 or newer.\nPlease download from https://www.visualstudio.com/en-us/products/visual-studio-community-vs.aspx.")
	else()
		get_filename_component(VAP_DEPENDENCY_INSTALL_DIR "${CMAKE_CURRENT_LIST_DIR}/../deps/x64" ABSOLUTE)
	endif()
...
# the doublethinkco cross-builds (see https://github.com/doublethinkco/cpp-vapory-cross).
#
...
#
# https://travis-ci.org/bobsummerwill/cpp-vapory/jobs/145955041
