...
macro(vap_copy_dll EXECUTABLE DLL)
...
macro(jsonrpcstub_create EXECUTABLE SPEC SERVERNAME SERVERDIR SERVERFILENAME CLIENTNAME CLIENTDIR CLIENTFILENAME)
	if (VAP_JSON_RPC_STUB)
		...
		COMMAND ${CMAKE_COMMAND} -DVAP_SPEC_PATH="${CMAKE_CURRENT_SOURCE_DIR}/${SPEC}" -DVAP_SOURCE_DIR="${CMAKE_SOURCE_DIR}" -DVAP_CMAKE_DIR="${VAP_CMAKE_DIR}"
			-DVAP_CLIENT_DIR="${CLIENTDIR}"
			-DVAP_CLIENT_NAME=${CLIENTNAME}
			-DVAP_CLIENT_FILENAME=${CLIENTFILENAME}
			-DVAP_SERVER_DIR="${SERVERDIR}"
			-DVAP_SERVER_NAME=${SERVERNAME}
			-DVAP_SERVER_FILENAME=${SERVERFILENAME}
			-DVAP_JSON_RPC_STUB="${VAP_JSON_RPC_STUB}"
			-P "${VAP_SCRIPTS_DIR}/jsonrpcstub.cmake"
			)
