...
macro(vap_add_test NAME) 
	...
	while (index LESS count)
		...
		add_test(NAME "${NAME}.${index}" COMMAND testvap ${run_test} ${test_arguments})
	...
	add_custom_target("test.${NAME}"
		...
		COMMAND ${CMAKE_COMMAND} -DVAP_TEST_NAME="${NAME}" -DCTEST_COMMAND="${CTEST_COMMAND}" -P "${VAP_SCRIPTS_DIR}/runtest.cmake"
	)
...
macro(vap_check_library_link L)
