...
#include <libvapcore/TransactionBase.h>
...
//			<< "    exportbare [ <uuid> , ... ]  Export given keys." << endl
			...
			<< "    createwallet  Create an Vapory master wallet." << endl
...
//			<< "    recode [ <address>|<uuid>|<file> , ... ]  Decrypt and re-encrypt given keys." << endl
			...
			<< "    --wallet-path <path>  Specify Vapory wallet path (default: " << KeyManager::defaultPath() << ")" << endl
