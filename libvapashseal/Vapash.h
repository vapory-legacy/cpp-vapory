...
#include <libvapory/GenericFarm.h>
...
class Vapash: public SealEngineBase
{
public:
	Vapash();
	~Vapash();

	std::string name() const override { return "Vapash"; }
	...
	vap::GenericFarm<VapashProofOfWork>& farm() { return m_farm; }
...
private:
	...
	vap::GenericFarm<VapashProofOfWork> m_farm;
