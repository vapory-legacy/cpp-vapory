...
{
	string const c_line = VapReset VapOnMaroon + string(80, ' ') + VapReset;
	string const c_border = VapReset VapOnMaroon + string(2, ' ') + VapReset VapMaroonBold;
	string const c_space = c_border + string(76, ' ') + c_border + VapReset;
	stringstream ss;
	ss << c_line << "\n";
	ss << c_space << "\n";
