...
void NoProof::init()
{
	VAP_REGISTER_SEAL_ENGINE(NoProof);
}
...
VVMSchedule const& SealEngineBase::vvmSchedule(u256 const& _blockNumber) const
{
...
{
	VVMSchedule const& schedule{vvmSchedule(_blockNumber)};
