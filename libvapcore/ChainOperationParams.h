...
struct ChainOperationParams
{
	...
	/// The chain sealer name: e.g. Vapash, NoProof, BasicAuthority
...
private:
	u256 m_blockReward;
public:
	VVMSchedule const& scheduleForBlockNumber(u256 const& _blockNumber) const;
	u256 blockReward(VVMSchedule const& _schedule) const;
