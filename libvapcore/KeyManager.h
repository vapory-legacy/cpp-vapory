...
// TODO: This one is specifically for Vapory, but we can make it generic in due course.
// TODO: hidden-partition style key-store.
/**
 * @brief High-level manager of password-encrypted keys for Vapory.
 * Usage:
 *
...
public:
	...
	static boost::filesystem::path defaultPath() { return getDataDir("vapory") / boost::filesystem::path("keys.info"); }
