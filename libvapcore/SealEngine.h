...
public:
	...
	virtual VVMSchedule const& vvmSchedule(u256 const& _blockNumber) const = 0;
...
public:
	...
	VVMSchedule const& vvmSchedule(u256 const& _blockNumber) const override;
...
#define VAP_REGISTER_SEAL_ENGINE(Name) static SealEngineFactory __vap_registerSealEngineFactory ## Name = SealEngineRegistrar::registerSealEngine<Name>(#Name)

class NoProof: public vap::SealEngineBase
{
public:
