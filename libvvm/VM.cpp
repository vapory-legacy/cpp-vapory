...
//
#define VVM_HACK_ON_OPERATION 0
#define VVM_HACK_STACK 0
#define VVM_HACK_UPDATE_IO_GAS 0
#define VVM_HACK_MUL_64 0
#define VVM_HACK_DUP_64 0
	...
	{	
		...
		CASE(SUICIDE)
		{
			...
			if (m_ext->balance(m_ext->myAddress) > 0 || m_schedule->zeroValueTransferChargesNewAccountGas())
				...
				// vapors to non-existing account.
