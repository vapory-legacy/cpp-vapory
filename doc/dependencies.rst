...
risk in case the cache server is compromised. In cpp-vapory we decided to
use only the cache server controlled by Vapory C++ team located in
https://github.com/vaporyco/hunter-cache.
