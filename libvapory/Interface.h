...
public:
	...
	/// @returns the VVMSchedule in the context of the pending block.
	virtual VVMSchedule vvmSchedule() const { return VVMSchedule(); }
	...
	/// NOTE: This only works when compiled with VAP_FATDB; otherwise will throw InterfaceNotSupported.
...
namespace std { void swap(dev::vap::Watch& _a, dev::vap::Watch& _b); }
...
inline void swap(dev::vap::Watch& _a, dev::vap::Watch& _b)
{
	swap(_a.m_c, _b.m_c);
