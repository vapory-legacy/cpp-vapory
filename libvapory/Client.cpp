...
std::ostream& dev::vap::operator<<(std::ostream& _out, ActivityReport const& _r)
{
...
#if defined(_WIN32)
const char* ClientNote::name() { return VapTeal "^" VapBlue " i"; }
const char* ClientChat::name() { return VapTeal "^" VapWhite " o"; }
const char* ClientTrace::name() { return VapTeal "^" VapGray " O"; }
const char* ClientDetail::name() { return VapTeal "^" VapCoal " 0"; }
#else
const char* ClientNote::name() { return VapTeal "⧫" VapBlue " ℹ"; }
const char* ClientChat::name() { return VapTeal "⧫" VapWhite " ◌"; }
const char* ClientTrace::name() { return VapTeal "⧫" VapGray " ◎"; }
const char* ClientDetail::name() { return VapTeal "⧫" VapCoal " ●"; }
#endif
...
void Client::init(p2p::Host* _extNet, fs::path const& _dbPath, WithExisting _forceAction, u256 _networkId)
{
	...
	auto host = _extNet->registerCapability(make_shared<VaporyHost>(bc(), m_stateDB, m_tq, m_bq, _networkId));
    m_host = host;

	_extNet->addCapability(host, VaporyHost::staticName(), VaporyHost::c_oldProtocolVersion); //TODO: remove this once v61+ protocol is common
