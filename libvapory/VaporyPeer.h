...
public:
	/// Basic constructor.
	VaporyPeer(std::shared_ptr<p2p::SessionFace> _s, p2p::HostCapabilityFace* _h, unsigned _i, p2p::CapDesc const& _cap);
...
private:
	...
	std::weak_ptr<VaporyPeerObserverFace> m_observer;
	std::weak_ptr<VaporyHostDataFace> m_hostData;
};
