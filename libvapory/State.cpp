...
const char* StateSafeExceptions::name() { return VapViolet "⚙" VapBlue " ℹ"; }
const char* StateDetail::name() { return VapViolet "⚙" VapWhite " ◌"; }
const char* StateTrace::name() { return VapViolet "⚙" VapGray " ◎"; }
const char* StateChat::name() { return VapViolet "⚙" VapWhite " ◌"; }
...
void State::commit(CommitBehaviour _commitBehaviour)
{
	if (_commitBehaviour == CommitBehaviour::RemoveEmptyAccounts)
		removeEmptyAccounts();
	m_touched += dev::vap::commit(m_cache, m_state);
	m_changeLog.clear();
	m_cache.clear();
...
std::ostream& dev::vap::operator<<(std::ostream& _out, State const& _s)
{
...
State& dev::vap::createIntermediateState(State& o_s, Block const& _block, unsigned _txIndex, BlockChain const& _bc)
{
	o_s = _block.state();
...
template <class DB>
AddressHash dev::vap::commit(AccountMap const& _cache, SecureTrieDB<Address, DB>& _state)
{
	AddressHash ret;
...
template AddressHash dev::vap::commit<OverlayDB>(AccountMap const& _cache, SecureTrieDB<Address, OverlayDB>& _state);
template AddressHash dev::vap::commit<MemoryDB>(AccountMap const& _cache, SecureTrieDB<Address, MemoryDB>& _state);
