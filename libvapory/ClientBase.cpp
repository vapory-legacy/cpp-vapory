...
const char* WatchChannel::name() { return VapBlue "ℹ" VapWhite "  "; }
const char* WorkInChannel::name() { return VapOrange "⚒" VapGreen "▬▶"; }
const char* WorkOutChannel::name() { return VapOrange "⚒" VapNavy "◀▬"; }
const char* WorkChannel::name() { return VapOrange "⚒" VapWhite "  "; }
...
std::pair<u256, ExecutionResult> ClientBase::estimateGas(Address const& _from, u256 _value, Address _dest, bytes const& _data, int64_t _maxGas, u256 _gasPrice, BlockNumber _blockNumber, GasEstimationCallback const& _callback)
{
	try
	{
		...
		int64_t lowerBound = Transaction::baseGasRequired(!_dest, &_data, VVMSchedule());
