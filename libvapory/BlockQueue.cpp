...
#if defined(_WIN32)
const char* BlockQueueChannel::name() { return VapOrange "[]>"; }
#else
const char* BlockQueueChannel::name() { return VapOrange "▣┅▶"; }
#endif
const char* BlockQueueTraceChannel::name() { return VapOrange "▣ ▶"; }
...
std::ostream& dev::vap::operator<<(std::ostream& _out, BlockQueueStatus const& _bqs)
{
...
std::ostream& dev::vap::operator<< (std::ostream& os, QueueStatus const& obj)
{
