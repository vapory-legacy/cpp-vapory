...
VaporyPeer::VaporyPeer(std::shared_ptr<SessionFace> _s, HostCapabilityFace* _h, unsigned _i, CapDesc const& _cap, uint16_t _capID):
...
bool VaporyPeer::interpret(unsigned _id, RLP const& _r)
{
	...
	case StatusPacket:
	{
		...
		setIdle();
		m_observer->onPeerStatus(dynamic_pointer_cast<VaporyPeer>(dynamic_pointer_cast<VaporyPeer>(shared_from_this())));
		break;
	}
	case TransactionsPacket:
	{
		m_observer->onPeerTransactions(dynamic_pointer_cast<VaporyPeer>(dynamic_pointer_cast<VaporyPeer>(shared_from_this())), _r);
		break;
	}
	...
	case BlockHeadersPacket:
	{
		...
		{
			setIdle();
			m_observer->onPeerBlockHeaders(dynamic_pointer_cast<VaporyPeer>(shared_from_this()), _r);
		}
		break;
	}
	...
	case BlockBodiesPacket:
	{
		...
		{
			setIdle();
			m_observer->onPeerBlockBodies(dynamic_pointer_cast<VaporyPeer>(shared_from_this()), _r);
		}
		break;
	}
	case NewBlockPacket:
	{
		m_observer->onPeerNewBlock(dynamic_pointer_cast<VaporyPeer>(shared_from_this()), _r);
		break;
	}
	case NewBlockHashesPacket:
	{
		...
		m_observer->onPeerNewHashes(dynamic_pointer_cast<VaporyPeer>(shared_from_this()), hashes);
		break;
	}
	...
	case NodeDataPacket:
	{
		...
		{
			setIdle();
			m_observer->onPeerNodeData(dynamic_pointer_cast<VaporyPeer>(shared_from_this()), _r);
		}
		break;
	}
	case ReceiptsPacket:
	{
		...
		{
			setIdle();
			m_observer->onPeerReceipts(dynamic_pointer_cast<VaporyPeer>(shared_from_this()), _r);
		}
		break;
	}
	default:
